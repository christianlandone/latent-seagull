...
static uint32_t pOverridesFiveH[] =
{
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetupFiveH =
{
    .commandNo = 0x3807,
    .status = 0x0000,
...
// CMD_PROP_TX
rfc_CMD_PROP_TX_t RF_cmdPropTxBeacon =
{
    .commandNo = 0x3801,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
// CMD_PROP_RX
rfc_CMD_PROP_RX_t RF_cmdPropRxBeacon =
{
    .commandNo = 0x3802,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_TX_ADV_t RF_cmdPropTxAdv =
{
  ...
  .preTrigger.triggerType = TRIG_NOW,/*TRIG_REL_START,*/
