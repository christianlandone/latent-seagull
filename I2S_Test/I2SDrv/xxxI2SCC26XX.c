...
bool I2SCC26XX_Params_init(I2SCC26XX_Params *params, I2SCC26XX_Mode mode, void *modeSpecificParams)
{
    if( mode == I2SCC26XX_I2S)
    {
        ...
        params->audioPinCfg.bitFields.ad1Usage = I2SCC26XX_ADUsageOutput;      /* I2S AD1 usage (0: Disabled, 1: Input, 2: Output) */
        params->audioPinCfg.bitFields.ad1NumOfChannels = 2;                      /* I2S AD1 number of channels (1 - 8). !Must match channel mask */
        params->audioPinCfg.bitFields.ad1ChannelMask = I2SCC26XX_STEREO_MODE;//I2SCC26XX_DISABLED_MODE;  /* I2S AD1 Channel Mask */
